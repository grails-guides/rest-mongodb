...
----
include::{sourceDir}/src/test/groovy/demo/ProductSpec.groovy[tags=imports,indent=0]
----
...
.src/test/groovy/demo/ProductSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductSpec.groovy[tags=mongoSpec,indent=0]
----
...
.src/test/groovy/demo/ProductSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductSpec.groovy[tags=createClient,indent=0]
----
...
.src/test/groovy/demo/ProductSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductSpec.groovy[tags=testName,indent=0]
    ...
}
----
...
.src/test/groovy/demo/ProductSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductSpec.groovy[tags=testInvalid,indent=0]
----
...
.src/test/groovy/demo/ProductSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductSpec.groovy[tags=testValid,indent=0]
----
