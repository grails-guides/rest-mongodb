...
[source,bash]
----
$ ./grailsw create-restful-controller mongodb.example.Product
| Created grails-app/controllers/mongodb/example/ProductController.groovy
----
...
----
include::{sourceDir}/grails-app/controllers/mongodb/example/ProductController.groovy[tag=controller, indent=0]
}
----
