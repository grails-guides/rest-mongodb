...
----
include::{sourceDir}/src/test/groovy/demo/ProductControllerSpec.groovy[tags=spec,indent=0]
    ...
}
----
...
.src/test/groovy/demo/ProductControllerSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductControllerSpec.groovy[tags=config,indent=0]
----
...
.src/test/groovy/demo/ProductControllerSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductControllerSpec.groovy[tags=setup,indent=0]
----
...
.src/test/groovy/demo/ProductControllerSpec.groovy
----
include::{sourceDir}/src/test/groovy/demo/ProductControllerSpec.groovy[tags=test,indent=0]
----
